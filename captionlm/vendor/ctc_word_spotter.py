# Vendored from NeMo: nemo/collections/asr/parts/context_biasing/ctc_based_word_spotter.py
# (Edited: tokenizer.ids_to_tokens -> vocabulary[idx]; import path updated)
